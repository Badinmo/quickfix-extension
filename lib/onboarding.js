...
export const WHY_LINE =
  "It's free, it's yours, and Kalam never sees it — your text goes straight from your browser to Google.";
...
export const STEPS = Object.freeze([
  ...
  { text: 'Paste it below — Kalam checks it the moment it lands.', screenshot: 'images/onboarding-4.png' }
]);
